            ...
            <div class="panel-body">
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="1" VALUE="<?= $data->nama ?>">
                    </div>
                    <div class="form-group">
                        <label class="control-label mb-10 text-left" for="example-email">Alamat </label>
                        <input type="text" id="example-email" value="<?= $data->alamat ?>" name="2" class="form-control"
                               placeholder="Email">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="example-email" name="5" value="<?= $data->deskripsi ?>"
                               class="form-control"
                               placeholder="Deksripsi">
                    </div>
                    <div class="form-group">
                        <label class="control-label mb-10 text-left" for="example-email">No Hp</label>
                        <input type="text" id="example-email" name="6" value="<?= $data->no_hp ?>" class="form-control"
                               placeholder="No Hp">
                    </div>
                    <div class="form-group">
